    ...
    <body>
        <div class="container"><br><br>
            <?php 
                ...
                $sql = 
                "SELECT * FROM movie_list ML INNER JOIN
                (SELECT movie_id FROM movie_director_list MD INNER JOIN
                (SELECT director_id FROM director_list WHERE director_name LIKE {$directorname}) AS D
                ON MD.director_id=D.director_id) AS M  
